...
#define SCANTOOL_SUB_VERSION      2
#define SCANTOOL_WIP_VERSION      0
#define SCANTOOL_VERSION_STR      "2.2"
#define SCANTOOL_VERSION_EX_STR   "2.2"
#define SCANTOOL_YEAR_STR         "2021"
#define SCANTOOL_DATE             20210320    /* yyyymmdd */
